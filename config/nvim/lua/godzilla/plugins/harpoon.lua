...
return {
  ...
  keys = {
    ...
    { '1', harpoonSelect(1), desc = 'Jump to [1]st window' },
    { '1', harpoonSelect(1), desc = 'Jump to [1]st window' },
    { '2', harpoonSelect(2), desc = 'Jump to [2]nd window' },
    { '3', harpoonSelect(3), desc = 'Jump to [3]rd window' },
    { '4', harpoonSelect(4), desc = 'Jump to [4]the window' },
